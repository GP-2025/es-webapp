...
import { MdAttachFile, MdSubject, MdMessage, MdSend } from "react-icons/md";
  ...
  return (
    open && (
      ...
      >
        <div
          ref={modalRef}
          className="relative w-full h-screen transform transition-all duration-300 ease-out flex flex-col"
